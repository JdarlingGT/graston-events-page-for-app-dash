...
export async function GET(
  ...
  const mockHistory = [
    { eventId: 'evt-1', eventName: 'Essential Training | Austin, TX', date: '2024-05-15', status: 'Completed' },
    { eventId: 'evt-3', eventName: 'Advanced Workshop | New York, NY', date: '2023-11-20', status: 'Completed' },
  ];
